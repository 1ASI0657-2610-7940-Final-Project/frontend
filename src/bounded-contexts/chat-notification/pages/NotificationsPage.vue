...
const markAllAsRead = async () => {
  try {
    ...
    console.warn('Backend markAllAsRead failed.', e)
  }
}
...
<template>
  <section class="notifications-page">
    ...
    <EmptyState
      ...
      message="Notifications will appear here when something real happens."
    />
        ...
        >
          ...
          <div class="content-col">
            ...
            <div class="notif-actions" v-if="item.actionType !== 'NONE'">
              <button v-if="item.actionType === 'PRIMARY'" class="action-btn-primary" @click="handleActionClick(item)">
                {{ item.actionLabel }}
              </button>
              <button v-else-if="item.actionType === 'SECONDARY'" class="action-btn-secondary" @click="handleActionClick(item)">
                {{ item.actionLabel }}
              </button>
              <a v-else-if="item.actionType === 'LINK'" href="#" class="action-link" @click.prevent="handleActionClick(item)">
                {{ item.actionLabel }}
              </a>
            </div>
          </div>
