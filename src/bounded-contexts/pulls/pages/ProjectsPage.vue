...
// Mock Projects representing the list in the screenshot to fill the screen if no backend data exists
const mockProjects = ref([
  ...
  {
    id: 'PRJ-2023-3355',
    title: 'Logo Vector Design',
    iconType: 'DOC',
    name: 'Visual Arts LLC',
    role: 'Client',
    avatar: null,
    status: 'CANCELLED',
    finalPrice: 150,
  ...
  {
    id: 'PRJ-2023-4466',
    title: 'Copywriting for SaaS Landing',
    iconType: 'DOC',
    name: 'Sarah Jenkins',
    role: 'Freelancer',
    avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150',
  ...
  {
    id: 'PRJ-2023-6688',
    title: 'Figma System Library',
    iconType: 'DOC',
    name: 'Design Systems Inc.',
    role: 'Client',
    avatar: null,
    status: 'IN_PROGRESS',
    finalPrice: 3200,
  ...
  {
    id: 'PRJ-2023-1006',
    title: 'Blogging & Content Strategy',
    iconType: 'DOC',
    name: 'SEO Copy Corp',
    role: 'Client',
    avatar: null,
  ...
  {
    id: 'PRJ-2023-1008',
    title: 'React Native Audio Plugin',
    iconType: 'CODE',
...
onMounted(async () => {
  try {
    ...
    console.warn('Backend fetchProjects failed, falling back to mockup dataset.', e)
  }
})
</script>
